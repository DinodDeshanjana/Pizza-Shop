...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Check available tuk tuk in the pickup district
    if (isset($_POST['Submit'])) {
        // Update vehicle availability
        $update_sql = "UPDATE vehicle SET available_tuktuk = available_tuktuk - 1 WHERE district = '$pickup'";
        mysqli_query($conn, $update_sql);

        // Insert booking details into the database
        $insert_sql = "INSERT INTO booking (user_id, pickup_district, dropoff_district, pickup_date, drop_date,Phone_number,Passport_ID,license) 
                       VALUES ('$user_id', '$pickup', '$dropoff', '$Pdate', '$Ddate','$Phone_number','$Passport_ID','$license')";
