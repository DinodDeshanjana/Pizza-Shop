...
$users_query = "SELECT user_id, first_name, last_name, email FROM user";
...
if (!$users_result) {
    ...
    $districts_query = "SELECT dropoff_district FROM booking WHERE user_id = $userId";
    ...
    $delete_bookings_query = "DELETE FROM booking WHERE user_id = $userId";
    mysqli_query($connection, $delete_bookings_query);

    // Delete the user
    $delete_user_query = "DELETE FROM user WHERE user_id = $userId";
...
<table>
    ...
    <?php while ($user = mysqli_fetch_assoc($users_result)) { ?>
        <tr>
            ...
            <td><a href="adminusers.php?delete_user=<?php echo $user['user_id']; ?>" class="btn-delete">Delete</a></td> 
        </tr>
    <?php } ?>
</table>
