...
$sql_booking = "SELECT booking_id, user_id, pickup_district, dropoff_district, pickup_date, drop_date,Phone_number,Passport_ID,license  FROM booking WHERE user_id = '$loggedInUserId'";
...
<div class="container">
    ...
    <div class="user-info">
        ...
        <p><strong>First Name: </strong> <br><input type="text" value="<?php echo  $user_data['first_name']; ?>" readonly></</p>
        <p><strong>Last Name: </strong><br><input type="text" value="<?php echo  $user_data['last_name']; ?>" readonly></p>
        ...
        <tbody>
            ...
            if (mysqli_num_rows($result_booking) > 0) {
                ...
                while ($booking_data = mysqli_fetch_assoc($result_booking)) {
                    echo "<tr>";
                    echo "<td>" . $booking_data['booking_id'] . "</td>";
                    echo "<td>" . $booking_data['pickup_district'] . "</td>";
                    echo "<td>" . $booking_data['dropoff_district'] . "</td>";
                    
                    echo "<td>" . $booking_data['pickup_date'] . "</td>";
                    echo "<td>" . $booking_data['drop_date'] . "</td>";
